...
void main()
{
    ...
    scanf("%f", &s3.attendence);
        ...
        printf("Enter the name of the student s4 : ");
        scanf("%s", s4.name); 
        printf("Enter the roll code of the student s4 : ");
        scanf("%s", s4.rollcode);
        printf("Enter the percentage of attendence of the student s4 : ");
        scanf("%f", &s4.attendence);
